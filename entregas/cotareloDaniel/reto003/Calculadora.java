package entregas.cotareloDaniel.reto003;
...
public class Calculadora {
    ...
    public void calcularFactorial() {
        if (verificarOperandos(1)) {
            ...
            if (numero < 0) {
                error = true;
                mensajeError = "No se puede calcular factorial de números negativos";
            } else {
                double factorial = 1;
    ...
    public void calcularMaximo() {
        if (posicionActual > 0) {
            ...
            error = true;
            mensajeError = "No hay valores para calcular el máximo";
        }
    }
    ...
    public void calcularMinimo() {
        if (posicionActual > 0) {
            ...
            error = true;
            mensajeError = "No hay valores para calcular el mínimo";
        }
    }
    ...
    public void intercambiar() {
        if (verificarOperandos(2)) {
            ...
            double penultimoValor = numeros[posicionActual - 2];

            numeros[posicionActual - 1] = penultimoValor;
