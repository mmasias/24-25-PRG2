package entregas.zablahBernardo.reto004;
...
public class Tiempo {
    ...
    public Tiempo(int horas, int minutos, int segundos) {
        assert verificarHora(horas) : "Hora no válida";
        assert verificarMinuto(minutos) : "Minuto no válido";
        assert verificarSegundo(segundos) : "Segundo no válido";
