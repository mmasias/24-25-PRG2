package entregas.castilloCayetano.reto003;
...
public class Calculadora {
    ...
    static final private int CAPACIDAD_POR_DEFECTO = 100;
    ...
    public void calcularMaximo(){
        if (verificarOperandos(2)) {
            double[] operandos = extraerOperandos(2);
            ingresarNumero(Math.max(operandos[0], operandos[1]));
        }
    }
    ...
    public void calcularMinimo(){
        if (verificarOperandos(2)) {
            double[] operandos = extraerOperandos(2);
            ingresarNumero(Math.min(operandos[0], operandos[1]));
        }
    }
    ...
    public void calcularRaizCuadrada(){
        if (verificarOperandos(1)) {
            double[] operandos = extraerOperandos(1);
            ingresarNumero(raizCuadrada(operandos[0]));
        }
    }
